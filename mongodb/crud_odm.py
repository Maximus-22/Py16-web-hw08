...
parser.add_argument("-a", "--action", help="create, update, read, delete")  # CRUD action
...
def delete(pk):
    try:
        ...
        print("Entity dosn't exists.")
        # по сутi однакова поведiнка [first()] та [get(indx)], бо повертається або [entity] або [None]
        return None
